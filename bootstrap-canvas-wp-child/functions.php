...
foreach (glob(get_template_directory() . "/models/*.php") as $filename)
{
    include $filename;
}
...
add_action( 'init', 'my_custom_post_homes', 0 );
...
function mh_scripts_styles() {
    ...
    wp_register_script('jquery','https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js');
  	...
  	wp_register_script('googlemaps_api',"https://maps.googleapis.com/maps/api/js?key=AIzaSyBp1V5CFJkGryiOLgWEYX3qayX1K-t9ycY&signed_in=true&callback=initMap");
    wp_register_script('ls_greensock','https://cdnjs.cloudflare.com/ajax/libs/gsap/2.0.1/TweenMax.min.js');
    ...
    wp_register_script('bootstrap_validator_js', get_stylesheet_directory_uri().'/js/validator.js');
    ...
    wp_register_style('bootstrap_validator_css', "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-validator/0.4.5/css/bootstrapvalidator.min.css ");


    /*   CALL ALL CSS AND SCRIPTS FOR SITE */
  	wp_enqueue_script('googlemaps_locations','','','',true);
  	wp_enqueue_script('googlemaps_api','','','',true);
    wp_enqueue_script('jquery');
    wp_enqueue_script('bs_js');
    wp_enqueue_script('bootstrap_validator_js','','','',true);
    wp_enqueue_script('ls_greensock','','','',true);
    wp_enqueue_script('ls_transitions','','','',true);
    wp_enqueue_script('ls_kreaturamedia_jquery','','','',true);
    wp_enqueue_script( 'scripts-js', get_template_directory_uri() . '/js/scripts.php', array( 'jquery' ), '', '', true );


   // wp_enqueue_style('main_style');
    wp_enqueue_style('ls_style');
    wp_enqueue_style('bootstrap_validator_css');
}
add_action( 'wp_enqueue_scripts', 'mh_scripts_styles' );

//defaults the gallery URLS to the full size image when accessed via the $post loop
...
//adds SVG support to uploaded images
...
//Remove the emoji bullcrap
remove_action( 'wp_head', 'print_emoji_detection_script', 7 ); 
remove_action( 'admin_print_scripts', 'print_emoji_detection_script' ); 
remove_action( 'wp_print_styles', 'print_emoji_styles' ); 
remove_action( 'admin_print_styles', 'print_emoji_styles' );

//enable html in sent emails
